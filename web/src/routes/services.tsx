        ...
        <div className="hidden md:flex items-center gap-1">
          {isAuth ? (
            <>
              ...
              <Link to="/services" className="px-3 py-1.5 text-sm font-medium transition-colors !text-white relative group">
                Services
                <span className="absolute bottom-0 left-1/2 -translate-x-1/2 w-4/5 h-0.5 bg-[#0070d1] rounded-full" />
              </Link>
              <Link to="/pricing" className="px-3 py-1.5 text-sm font-medium transition-colors !text-white/70 hover:!text-white relative group">
                Pricing
                <span className="absolute bottom-0 left-1/2 -translate-x-1/2 w-0 h-0.5 bg-[#0070d1] transition-all duration-300 group-hover:w-4/5 rounded-full" />
              </Link>
